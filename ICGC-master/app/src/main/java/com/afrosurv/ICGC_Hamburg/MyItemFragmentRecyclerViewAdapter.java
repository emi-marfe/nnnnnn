...
import com.afrosurv.ICGC_Hamburg.ItemFragment.OnListFragmentInteractionListener;
...
public class MyItemFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MyItemFragmentRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemFragmentRecyclerViewAdapter(List<com.afrosurv.ICGC_Hamburg.PictureItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
